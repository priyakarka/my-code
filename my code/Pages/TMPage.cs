    ...
    internal class TMPage
    {
        public void CreateTM(IWebDriver driver)
        {
           ...
           wait.WaitToBeClickable(driver, "XPath", "//*[@id='TypeCode_listbox']/li[1]");
            ...
            Assert.That(actualDescription.Text == "my code", "Actual description and expected code do not match");
        ...
        public void EditTM(IWebDriver driver)
        {
            ...
            if (findRecordCreated.Text == "my code")
            {
            ...
            IWebElement codeTextbox = driver.FindElement(By.Id("Code"));
            codeTextbox.Clear();
            codeTextbox.SendKeys("Editedmy code");


            // Edit description
            IWebElement descriptionTextbox = driver.FindElement(By.Id("Description"));
            descriptionTextbox.Clear();
            descriptionTextbox.SendKeys("Editedmy code");
            ...
            Assert.That(createdDescription.Text == "Editedmy code", "Description record hasn't been edited.");
        ...
        if (findEditedRecord.Text == "Editedmy code")
        {
